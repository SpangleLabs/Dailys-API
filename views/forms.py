...
class FormsBlueprint(BaseBlueprint):
    ...
    def register(self):
        ...
        self.blueprint.route("/raw/<stat_name>/<view_date:view_date>/", methods=['GET'])(self.raw_form)
        self.blueprint.route("/raw/<stat_name>/<view_date:view_date>/", methods=['POST'])(self.raw_form_post)
    ...
    def raw_form(self, stat_name, view_date):
        ...
        return flask.render_template("form_raw.html", stat_name=stat_name, view_date=view_date, raw_data=raw_data)
